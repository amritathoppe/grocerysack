	...
	<?php
	 ...
	 echo'<li><a href="#">'.$row1[0].'</a></li>';
		  ...
		  <ul class="nav navbar-nav navbar-right">
			<li><a href="settings.php"><span class="glyphicon glyphicon-user"></span> Logged In</a></li>
...
<a href="dashboard.php" >Back to Shopping</a> </a><a id="btnEmpty" href="cart.php?action=empty">Empty Cart</a></div> 
<?php
...
<?php		
    foreach ($_SESSION["cart_item"] as $item){
		?>
				...
				<td><a href="cart.php?action=remove&product_code=<?php echo $item["product_code"]; ?>" class="btnRemoveAction">Remove Item</a></td>
				</tr>
				<?php
...
<tr><td colspan="5" align=right><input type="submit" value="Order Now"></td></form>
</tr>
</tbody>
</table>		
  <?php
